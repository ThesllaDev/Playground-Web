<h1 align="center"> Tabela de Classificação da <abbr title="National Basketball Association">NBA</abbr></h1>
<p align="center">Feito para aprender e praticar sobre tabela html e arrays, objetos, manipulação do DOM no js usando eventos e funções</p>
