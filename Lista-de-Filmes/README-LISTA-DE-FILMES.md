<h1 align="center"> Lista de Filmes - Indicações de filmes para assistir </h1>
<p align="center">Feito para aprender e praticar sobre arrays, manipulação do DOM no js usando eventos, funções e estrutura de repetição e condição</p>
